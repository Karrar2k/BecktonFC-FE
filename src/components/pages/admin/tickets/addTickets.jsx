...
export default function AddTicketFormComponent() {
  ...
  const handleFileUpload = async (event) => {
    ...
    const res = await axios.post("https://becktonfc-be.onrender.com/api/upload", fileData, {
      headers: {
  ...
  const handleSubmit = async (event) => {
    ...
    if (id) {
      const res = await axios.put(
        "https://becktonfc-be.onrender.com/api/ticket/" + id,
        formData,
        {
          headers: {
            authorization: "Bearer " + token,
      ...
      const res = await axios.post(
        "https://becktonfc-be.onrender.com/api/ticket/create",
        formData,
        {
          headers: {
            authorization: "Bearer " + token,
  ...
  const fetchTicketDetails = async () => {
    const res = await axios.get(`https://becktonfc-be.onrender.com/api/ticket/${id}`, {
      headers: {
        authorization: "Bearer " + token,
      },
    });
