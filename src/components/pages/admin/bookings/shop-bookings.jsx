...
export default function AdminShowBookingsComponent() {
  ...
  const fetchOrderDetails = async () => {
    const res = await axios.get("https://becktonfc-be.onrender.com/api/book/all", {
      headers,
    });
    if (res.status === 200) {
  ...
  const cancelOrder = async (order) => {
    const res = await axios.post(
      "https://becktonfc-be.onrender.com/api/book/cancel",
      order,
      {
        headers,
      }
  ...
  const completeOrder = async (order) => {
    const res = await axios.post(
      "https://becktonfc-be.onrender.com/api/book/dispatch",
      order,
      {
        headers,
      }
  ...
  const deleteOrder = async (order) => {
    const res = await axios.delete(
      "https://becktonfc-be.onrender.com/api/book/" + order._id,
      {
        headers,
      }
    );
