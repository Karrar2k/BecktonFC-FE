...
export default function AddShopFormComponent() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (id) {
      const res = await axios.put(
        `https://becktonfc-be.onrender.com/api/shop/${id}`,
        formData,
        {
          headers: {
            authorization: "Bearer " + token,
      ...
      const res = await axios.post(
        "https://becktonfc-be.onrender.com/api/shop/create",
        formData,
        {
          headers: {
            authorization: "Bearer " + token,
  ...
  const fetchProductDetails = async () => {
    const res = await axios.get(`https://becktonfc-be.onrender.com/api/shop/${id}`, {
      headers: {
        authorization: "Bearer " + token,
      },
    });
